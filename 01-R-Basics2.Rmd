...
student heights in my class
```{r}
studentHeightsInMyClass <-  c(177, 162, 188)
student_heights_in_my_class <- c(177, 162, 188)
```

```{r}
StudentHeightsInMyClass
```
